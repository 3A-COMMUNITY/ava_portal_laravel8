@extends('layouts.app', [
    'class' => 'login-page',
    'backgroundImagePath' => 'img/bg/BG1.jpg'
])
                    ...
                    <div class="card card-login">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="{{ __('Palavra-passe') }}" type="password" required>
